...
public:
    ...
    void setupUi(QDialog *Usuario)
    {
        ...
        Usuario->resize(712, 790);
        layoutWidget = new QWidget(Usuario);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 100, 671, 229));
        ...
        gridLayout_2->addWidget(lineEdit_9, 1, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_10, 2, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_11, 3, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_12, 4, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_13, 5, 1, 1, 1);
        ...
        layoutWidget1 = new QWidget(Usuario);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(20, 40, 253, 29));
        ...
        plainTextEdit = new QPlainTextEdit(Usuario);
        plainTextEdit->setObjectName(QStringLiteral("plainTextEdit"));
        plainTextEdit->setGeometry(QRect(20, 340, 671, 431));
