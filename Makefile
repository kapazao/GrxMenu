...
qrc_iconos.cpp: iconos.qrc \
		...
		iconos/salida.jpg \
		iconos/update.png \
		iconos/asistencia.png \
		iconos/WebMail.png \
		iconos/usuario_on.png \
		iconos/ISL50x50.png \
		iconos/lupa.jpg \
		iconos/usuario_off.png \
		iconos/color.xcf \
		iconos/Router.png \
		iconos/AD.png \
		iconos/beiro_cartera.png \
		iconos/Linux_pc.png \
		iconos/300px-Granada_-_Mapa_municipal.svg.png \
		iconos/lupa.png \
		iconos/glpi.png \
		iconos/usuario.png \
		iconos/logo.png \
		iconos/color.jpg \
		iconos/Printer_pc.png \
		iconos/atalaya.png \
		iconos/usuarios.png
