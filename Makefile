...
INCPATH       = -I. -I../Qt/5.9.2/gcc_64/include -I../Qt/5.9.2/gcc_64/include/QtWidgets -I../Qt/5.9.2/gcc_64/include/QtGui -I../Qt/5.9.2/gcc_64/include/QtSql -I../Qt/5.9.2/gcc_64/include/QtNetwork -I../Qt/5.9.2/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I. -I../Qt/5.9.2/gcc_64/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
LINK          = g++
LFLAGS        = -fpermissive -Wl,-O1 -Wl,-rpath,/home/alberto/Qt/5.9.2/gcc_64/lib
...
SOURCES       = main.cpp \
		...
		equipos.cpp \
		tunel.cpp \
		ejecutahilo.cpp moc_botonera.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents botonera.h configuracion.h usuario.h nmap_xml.h sedes.h soporte.h equipos.h tunel.h ejecutahilo.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp botonera.cpp configuracion.cpp usuario.cpp nmap_xml.cpp sedes.cpp soporte.cpp equipos.cpp tunel.cpp ejecutahilo.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_botonera.cpp moc_configuracion.cpp moc_usuario.cpp moc_sedes.cpp moc_soporte.cpp moc_equipos.cpp moc_tunel.cpp moc_ejecutahilo.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_botonera.cpp moc_configuracion.cpp moc_usuario.cpp moc_sedes.cpp moc_soporte.cpp moc_equipos.cpp moc_tunel.cpp moc_ejecutahilo.cpp
