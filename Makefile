...
DISTDIR = /home/alberto/Programacion/GrxMenu/.tmp/GrxMenu1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/alberto/Qt/5.9.2/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/alberto/Qt/5.9.2/gcc_64/lib -lQt5Widgets -lQt5Gui -lQt5Sql -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents botonera.h configuracion.h usuario.h nmap_xml.h sedes.h soporte.h equipos.h libreria.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp botonera.cpp configuracion.cpp usuario.cpp nmap_xml.cpp sedes.cpp soporte.cpp equipos.cpp libreria.cpp $(DISTDIR)/
...
moc_predefs.h: ../../Qt/5.9.2/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h ../../Qt/5.9.2/gcc_64/mkspecs/features/data/dummy.cpp
...
libreria.o: libreria.cpp ../../Qt/5.9.2/gcc_64/include/QtNetwork/QTcpServer \
		../../Qt/5.9.2/gcc_64/include/QtNetwork/qtcpserver.h \
		../../Qt/5.9.2/gcc_64/include/QtNetwork/qtnetworkglobal.h \
		../../Qt/5.9.2/gcc_64/include/QtCore/qglobal.h \
		../../Qt/5.9.2/gcc_64/include/QtCore/qconfig-bootstrapped.h \
