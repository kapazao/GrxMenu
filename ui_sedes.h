...
public:
    ...
    void setupUi(QWidget *Sedes)
    {
        ...
        QWidget::setTabOrder(comboBox_IP, comboBox_TLF);
        QWidget::setTabOrder(comboBox_TLF, comboBox_extension);
        QWidget::setTabOrder(comboBox_extension, comboBox_CP);
        QWidget::setTabOrder(comboBox_CP, lineEdit_via);
        QWidget::setTabOrder(lineEdit_via, lineEdit_direccion);
        QWidget::setTabOrder(lineEdit_direccion, lineEdit_numero);
        ...
        QWidget::setTabOrder(lineEdit_contacto, comboBox_email);
        QWidget::setTabOrder(comboBox_email, comboBox_telefonos);
